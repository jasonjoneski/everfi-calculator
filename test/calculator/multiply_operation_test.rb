...
class MultiplyOperationTest < ActiveSupport::TestCase
  test "MultiplyOperation.new creates valid object." do
    term1 = TerminalOperation.new(10)
    term2 = TerminalOperation.new(10)
    operation = MultiplyOperation.new(term1, term2)
  ...
  test "calculate adds left and right together." do
    ...
    assert_equal 35, operation.calculate()
  end
